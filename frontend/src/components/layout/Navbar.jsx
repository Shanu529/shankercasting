          ...
          {!user ? (
            <>
              <button
                ...
                className="px-5 py-2 rounded-full border border-orange-500 text-orange-400 hover:bg-orange-500 hover:text-white transition"
              >
                Signup
              </button>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {profileOpen && (
                <div className="absolute right-0 top-full mt-3 w-56 bg-gray-900 border border-gray-700 shadow-2xl rounded-xl p-5 z-[60]">
